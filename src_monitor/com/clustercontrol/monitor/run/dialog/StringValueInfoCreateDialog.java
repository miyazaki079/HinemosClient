...
public class StringValueInfoCreateDialog extends CommonDialog {
	...
	protected void setInputData() {
		...
		// 処理する／しない
		if (m_inputData.getProcessType() == ProcessConstant.TYPE_YES) {
		...
		// 重要度
		this.m_comboPriority.setText(PriorityConstant.typeToString(m_inputData.getPriority()));
		...
		// 有効／無効
		if (m_inputData.isValidFlg() == ValidConstant.BOOLEAN_VALID) {
