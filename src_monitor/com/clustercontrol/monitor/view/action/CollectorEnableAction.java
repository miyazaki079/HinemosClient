 ...
 * @since 4.0.0
 */
public class CollectorEnableAction extends AbstractHandler implements IElementUpdater {

	// ログ
	private static Log m_log = LogFactory.getLog( CollectorEnableAction.class );

	/** アクションID */
	public static final String ID = CollectorEnableAction.class.getName();
