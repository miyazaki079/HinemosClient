...
public class WinEventDialog extends CommonMonitorStringDialog {
	 ...
	 */
	public WinEventDialog(Shell parent, String managerName, int monitorType) {
	...
	protected void customizeDialog(Composite parent) {
		...
		if(this.monitorId == null){
			...
			try {
				...
				info = wrapper.getMonitor(this.monitorId, HinemosModuleConstant.MONITOR_WINEVENT);
	...
	protected MonitorInfo createInputData() {
		...
		try {
			...
			setValidateResult(Messages.getString("message.hinemos.1"), e.getMessage() + "\n"+Messages.getString("winevent.id"));
		}
