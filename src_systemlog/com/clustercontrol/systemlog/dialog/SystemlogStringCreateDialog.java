...
public class SystemlogStringCreateDialog extends CommonMonitorStringDialog {
	 ...
	 */
	public SystemlogStringCreateDialog(Shell parent, String managerName, int monitorType) {
	...
	protected void customizeDialog(Composite parent) {
		...
		if(this.monitorId == null){
			...
			try {
				...
				info = wrapper.getMonitor(this.monitorId, HinemosModuleConstant.MONITOR_SYSTEMLOG);
