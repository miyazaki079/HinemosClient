...
public class PageCreateDialog extends CommonDialog {
	...
	protected void customizeDialog(Composite parent) {
		...
		this.m_comboNotify.add(PriorityConstant.STRING_CRITICAL);
		this.m_comboNotify.add(PriorityConstant.STRING_WARNING);
		this.m_comboNotify.add(PriorityConstant.STRING_INFO);
		this.m_comboNotify.add(PriorityConstant.STRING_UNKNOWN);
		this.m_comboNotify.add(PriorityConstant.STRING_NONE);
		this.m_comboNotify.setText(PriorityConstant.STRING_CRITICAL);
	...
	protected void setInputData() {
		if(this.m_inputData == null){
			...
			this.m_comboNotify.select(this.m_comboNotify.indexOf(PriorityConstant.typeToString(this.m_inputData.getPriority())));
		}
	...
	protected Page createInputData() {
		...
		page.setPriority(PriorityConstant.stringToType(this.m_comboNotify.getText()));
