...
public class HttpNumericCreateDialog extends CommonMonitorNumericDialog {
	 ...
	 */
	public HttpNumericCreateDialog(Shell parent, String managerName, int monitorType) {
	...
	protected void customizeDialog(Composite parent) {
		...
		if(this.monitorId == null){
			...
			// 変更の場合、情報取得
			info = new GetHttp().getHttp(this.getManagerName(), this.monitorId, MonitorTypeMstConstant.MONITOR_TYPE_NUMERIC);
		}
