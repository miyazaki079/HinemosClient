...
public class AccessEndpointWrapper {
	...
	public void checkLogin( EndpointUnit endpointUnit ) throws HinemosUnknown_Exception, InvalidRole_Exception, InvalidUserPass_Exception{
	...
	public RoleInfo getRoleInfo(String roleId) throws HinemosUnknown_Exception, InvalidRole_Exception, InvalidUserPass_Exception {
		WebServiceException wse = null;
		for (EndpointSetting<AccessEndpoint> endpointSetting : getAccessEndpoint(endpointUnit)) {
			try {
				AccessEndpoint endpoint = endpointSetting.getEndpoint();
