...
public class GetJobKickTableDefine {
	...
	/** 実行契機ID */
	public static final int SCHE_ID = 2;
	/** 実行契機名 */
	public static final int SCHE_NAME = 3;
	/** ジョブID */
	...
	public static final int SORT_COLUMN_INDEX2 = SCHE_ID;
