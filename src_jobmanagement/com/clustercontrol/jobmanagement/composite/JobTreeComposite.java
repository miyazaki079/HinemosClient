...
public class JobTreeComposite extends Composite {
	...
	/** 選択ジョブツリーアイテムリスト */
	private List<JobTreeItem> m_selectItemList = new ArrayList<JobTreeItem>();
	/** ツリーのみ */
	...
	public void doSearch( String keyword ){
		...
		if( null != result ){
			...
			MessageDialog.openInformation( this.getShell(), Messages.getString("message"), Messages.getString("jobmanagement.search.not.found") );
	...
	private void setFocus (JobTreeItem item, String jobId) {
