	...
	private Property getStopProperty(String managerName, String sessionId, String jobunitId, String jobId, String facilityId) {
		...
		if (facilityId == null) {
			...
			Object endStatusList[][] = {
					{"", EndStatusConstant.STRING_NORMAL, EndStatusConstant.STRING_WARNING, EndStatusConstant.STRING_ABNORMAL},
		...
		if(values1.contains(OperationConstant.STRING_STOP_SKIP)) {
			values2.add(OperationConstant.STRING_STOP_SKIP);
		}
		...
		if(	OperationConstant.STRING_STOP_MAINTENANCE.equals(controlStr) ||
				OperationConstant.STRING_STOP_FORCE.equals(controlStr)){
			if (endStatus != null) {
