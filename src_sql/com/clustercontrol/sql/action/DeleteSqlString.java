...
/**
 * SQL監視（文字列）情報を削除するクライアント側アクションクラス<BR>
 *
 * @version 4.0.0
 * @since 2.0.0
 */
public class DeleteSqlString implements DeleteInterface{
	...
	public boolean delete(String managerName, List<String> monitorIdList) throws Exception {
		...
		return wrapper.deleteMonitor(monitorIdList, HinemosModuleConstant.MONITOR_SQL_S);
	}
}
