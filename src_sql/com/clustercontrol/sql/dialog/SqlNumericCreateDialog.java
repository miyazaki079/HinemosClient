...
public class SqlNumericCreateDialog extends CommonMonitorNumericDialog {
	 ...
	 */
	public SqlNumericCreateDialog(Shell parent, String managerName, int monitorType) {
	...
	protected void customizeDialog(Composite parent) {
		...
		if(this.monitorId == null){
			...
			// 変更の場合、情報取得
			info = new GetSql().getSql(this.getManagerName(), this.monitorId, MonitorTypeMstConstant.MONITOR_TYPE_NUMERIC);
		}
	...
	protected MonitorInfo createInputData() {
		...
		//SQL監視固有情報を設定
		monitorInfo.setMonitorTypeId(HinemosModuleConstant.MONITOR_SQL_N);

		// 監視条件 SQL監視情報
		SqlCheckInfo sqlInfo = new SqlCheckInfo();
		sqlInfo.setMonitorTypeId(HinemosModuleConstant.MONITOR_SQL_N);
