...
public class SqlStringCreateDialog extends CommonMonitorStringDialog {
	 ...
	 */
	public SqlStringCreateDialog(Shell parent, String managerName, int monitorType) {
	...
	protected void customizeDialog(Composite parent) {
		...
		if(this.monitorId == null){
			...
			// 変更の場合、情報取得
			info = new GetSql().getSql(this.managerName, this.monitorId, MonitorTypeMstConstant.MONITOR_TYPE_STRING);
		}
