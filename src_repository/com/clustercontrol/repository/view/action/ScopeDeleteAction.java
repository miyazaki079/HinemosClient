...
public class ScopeDeleteAction extends AbstractHandler implements IElementUpdater {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		ScopeListView view = (ScopeListView) this.viewPart.getAdapter(ScopeListView.class);

		List<?> selectionList = view.getSelectedScopeItems();
		...
		if (size == 1) {
			...
			args[0] = new Integer(size).toString();
