...
public class UpOrderInfraModuleAction extends AbstractHandler implements IElementUpdater {
	/** アクションID */
	public static final String ID = UpOrderInfraModuleAction.class.getName();
			...
			if( null != page ){
				...
				if(part instanceof InfraModuleView){
					...
					if(selection != null && selection.size() == 1
							...
							&& (int)((ArrayList<?>)selection.getFirstElement()).get(GetInfraModuleTableDefine.ORDER_NO) > 1){
						enable = true;
					}
				}
