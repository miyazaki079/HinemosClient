 ...
 * @since 5.0.0
 */
public class InfraModuleAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		//ビューを表示する
		try {
			page.showView(InfraModuleView.ID);
			IViewPart viewPart = page.findView(InfraModuleView.ID);
			InfraModuleView view = (InfraModuleView) viewPart
					.getAdapter(InfraModuleView.class);
			view.setFocus();
