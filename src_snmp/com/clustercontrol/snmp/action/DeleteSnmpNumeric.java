...
/**
 * SNMP監視（数値）情報を削除するクライアント側アクションクラス<BR>
 *
 * @version 4.0.0
 * @since 2.0.0
 */
public class DeleteSnmpNumeric implements DeleteInterface{

	/**
	 * SNMP監視（数値）情報を削除します。<BR>
	 *
	...
	public boolean delete(String managerName, List<String> monitorIdList) throws Exception {
		...
		return wrapper.deleteMonitor(monitorIdList, HinemosModuleConstant.MONITOR_SNMP_N);
	}
}
